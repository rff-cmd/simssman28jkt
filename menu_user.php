...
<!--PERPUSTAKAAN-->
<?php if ( allow("frmperpustakaan")==1 || allow("frmformat")==1 || allow("frmrak")==1 || allow("frmkatalog")==1 || allow("frmpenerbit")==1 || allow("frmpenulis")==1 || allow("frmpustaka")==1 || allow("frmpinjam")==1 || allow("frmkembali")==1 || allow("rpt_pinjam_telat")==1 || allow("frmkonfigurasi")==1 || allow("frmsupplier")==1 || allow("frmanggota")==1 || allow("frmperpustakaan")==1 ) { ?>
...
<!--ASSET-->
<?php if ( allow("frmmaterial")==1 || allow("frmitem_group")==1 || allow("frmbrand")==1 || allow("frmbuild")==1 || allow("frmasset_type")==1 || allow("frmroom")==1 || allow("frmroom_booking")==1 ) { ?>
...
<!--SURAT MENYURAT-->
<?php if ( allow("frmkelompok_surat")==1 || allow("frmsurat_keluar")==1 || allow("frmsurat_masuk")==1 || allow("frmbuku_kunjungan")==1 ) { ?>
