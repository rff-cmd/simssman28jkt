						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									...
									while($row_pelajaran_un_minat_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row_pelajaran_un_minat_view->nama ?></td>
                                            <td align="center"><?php echo $row_pelajaran_un_minat_view->urutan ?></td>
                                            <td align="left"><?php echo $row_pelajaran_un_minat_view->uid ?></td>
                                            <td align="left"><?php echo $row_pelajaran_un_minat_view->dlu ?></td>
                                            <td align="center">                                            
                                                <?php if (allowupd('frmpelajaran_un_minat')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('pelajaran_un_minat') ?>/<?php echo $row_pelajaran_un_minat_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
