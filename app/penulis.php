...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="penulis" id="penulis" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('kode,nama');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kode" name="kode" class="form-control" value="<?php echo $penulis_data->kode ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="gelardepan" name="gelardepan" class="form-control" value="<?php echo $penulis_data->gelardepan ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $penulis_data->nama ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="gelarbelakang" name="gelarbelakang" class="form-control" value="<?php echo $penulis_data->gelarbelakang ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kontak</label>
					<div class="col-sm-3">
						<input type="text" id="kontak" name="kontak" class="form-control" value="<?php echo $penulis_data->kontak ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Biografi</label>
					<div class="col-sm-3">
						<textarea id="biografi" name="biografi" class="form-control"><?php echo $penulis_data->biografi ?></textarea>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $penulis_data->keterangan ?></textarea>
					</div>
				</div>
