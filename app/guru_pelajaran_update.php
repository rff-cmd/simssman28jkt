		...
		?>								
				...
				<tr style="background-color:ffffff;" > 
					...
					<td id="kode_id<?php echo $no ?>">
						<input type="text" id="kode_<?php echo $no ?>" name="kode_<?php echo $no ?>" class="form-control" style="width: 100px" onblur="loadHTMLPost3('<?php echo $__folder ?>app/guru_kode_ajax.php','kode_id<?php echo $no ?>','cekkode_update','nip_<?php echo $no ?>','kode_<?php echo $no ?>','<?php echo $no ?>')" value="<?php echo $row_guru_detail->kode; ?>" >	
					</td>
					...
					<td align="center">
						<input type="checkbox" id="input_pas_<?php echo $no; ?>" name="input_pas_<?php echo $no; ?>" style="text-align: right;" class="ace" value="1" <?php echo $input_pas ?> ><span class="lbl"></span>
					</td>
