...
<tr height="150">
    ...
    <!---------multi penerimaan----------->
	<table class="table" border="0" align="center" cellspacing="0" cellpadding="5">
	    ...
	    <tr>
	    	...
	    	<td colspan="2">
		    	<select name="idjenis_bayar" id="idjenis_bayar" style="min-width: 178px; height:27px; " >
    ...
    <?php /*
   	<table class="table" border="0" width="95%" cellpadding="2" cellspacing="2" align="center">
	<!-- TABLE CONTENT -->
    <tr>
