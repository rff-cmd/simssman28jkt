...
?>		
		<select name="idtingkat2" id="idtingkat2" style="min-width: 178px;  font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/besarjtt_ajax.php','idkelas2','gettingkat','idtingkat2', 'idangkatan')" >
			<option value=""></option>
