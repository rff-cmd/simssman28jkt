<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('setup_siswa_khusus_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_setup_siswa_khusus($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('setup_siswa_khusus_view') ?>" />
			<?php
					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_setup_siswa_khusus("", $jenis, $all);
						            while($setup_siswa_khusus_view=$sql->fetch(PDO::FETCH_OBJ)){
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $setup_siswa_khusus_view->jenis ?></td>
											<td><?php echo date("d-m-Y", strtotime($setup_siswa_khusus_view->tanggal)) ?></td>
											<td><?php echo date("d-m-Y", strtotime($setup_siswa_khusus_view->tanggal1)) ?></td>
											<td><?php echo $setup_siswa_khusus_view->uid ?></td>
											<td><?php echo $setup_siswa_khusus_view->dlu ?></td>								
											<td align="center">
                                            
                                                <?php if (allowupd('frmsetup_siswa_khusus')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('setup_siswa_khusus') ?>/<?php echo $setup_siswa_khusus_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmsetup_siswa_khusus')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $setup_siswa_khusus_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
