								...
								<div>
									...
									<table border="0" width="100%">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" style="width:auto;   font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/assesmen_observasi_ajax.php','idtingkat','gettingkat','departemen')" />
													<option value=""></option>
											...
											<td>:</td>
											<td>
												<select name="idtingkat" id="idtingkat" style="width:auto;   font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/assesmen_observasi_ajax.php','idkelas','getkelas','idtingkat')" />
													<option value=""></option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="idkelas" id="idkelas" style="width:auto;  font-size:12px; padding:0px; " onClick="loadHTMLPost2('app/assesmen_observasi_ajax.php','idsiswa','getsiswa','idkelas')" />
													<option value=""></option>
