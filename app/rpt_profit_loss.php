						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th><?php if($lng==1) { echo 'Debit Amount'; } else { echo 'Nilai Debet'; } ?></th>
									<th><?php if($lng==1) { echo 'Credit Amount'; } else { echo 'Nilai Kredit'; } ?></th>  
								</tr>
							</thead>
							...
							<tbody>
                                ...
                                <?php
                                	$purchase_amount 		= $selectview->pl_purchase_invoice($from_date, $to_date);
                                	$sales_amount			= $selectview->pl_sales_invoice($from_date, $to_date);
                                	$purchase_return_amount	= $selectview->pl_purchase_return($from_date, $to_date);
                                	
                                	$total_amount		= $sales_amount - ($purchase_amount - $purchase_return_amount);	
                                ?>     
                                <tr>
                                    <td>Pembelian</td>
                                    <td align="right"><?php echo number_format($purchase_amount,"2",".",",") ?></td>
								...
								<tr>
                                    ...
                                    <td align="right"><?php echo number_format(0,"2",".",",") ?></td>
                                    <td align="right"><?php echo number_format($purchase_return_amount,"2",".",",") ?></td>
								...
								<tr>
                                    <td>Penjualan</td>
                                    <td align="right"><?php echo number_format(0,"2",".",",") ?></td>
                                    <td align="right"><?php echo number_format($sales_amount,"2",".",",") ?></td>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		.dataTable( {
			...
			"aoColumns": [
			  { "bSortable": false },
			  null,     //kalau nambah kolom, null ditambahkan
			  { "bSortable": false }
			],
			"aaSorting": [],
