<?php
    ...
    $fileName 	= $_FILES["file_k"]["tmp_name"];
    if($fileName == "") {
?>        
		<table class="table" align="center" style="font-size: 36px; color: #271aa4">
			<tr>
				<td align="center"><?php echo "File keterampilan belum dipilih" ?></td>
			</tr>
...
?>        
			<table class="table" align="center" style="font-size: 36px; color: #ff0000">
				<tr>
...
<table class="table" align="center" style="font-size: 36px; color: #07581c">
	<tr>
		<td><?php echo "Upload Data Nilai Keterampilan Sukses..."; ?></td>
	</tr>
</table>
