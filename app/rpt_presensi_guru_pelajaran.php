					...
					<form class="form-horizontal" role="form" action="" method="post" name="rpt_presensi_harian_siswa" id="rpt_presensi_harian_siswa" class="form-horizontal" enctype="multipart/form-data" >
						...
						<div class="form-group">
		                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tingkat</label>		                    	<div class="col-sm-3">
		                    	<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost2('app/rpt_presensi_guru_pelajaran_ajax.php','kelas_id','getkelas','idtingkat')" >
									<option value=""></option>
						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$total = 0;													
									$sql=$selectview->rpt_presensi_pelajaran_guru($daritgl, $ketgl, $nis, $idkelas, $idtingkat, $nama, $departemen);												
