						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th><?php if($lng==1) { echo 'Location'; } else { echo 'Gudang'; } ?></th>
							...
							<tbody>
                                <?php			
									...
									while($row_good_receipt=$sql->fetch(PDO::FETCH_OBJ)){
			                                ...
			                                /*$item_name = "";
			                                $sql2=$select->list_good_receipt_detail($row_good_receipt->ref);
			                                while($row_good_receipt_det=$sql2->fetch(PDO::FETCH_OBJ)) {
			                                    if($item_name == "") {
			                                        $item_name =  $row_good_receipt_det->item_name; 
			                                    } else {
			                                        $item_name =  $item_name . '<br>' . $row_good_receipt_det->item_name; 
			                                    }
                                        ...
                                        <tr>
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmgood_receipt')==1) { ?>
    												<a href="<?php echo obraxabrix('good_receipt') ?>/<?php echo $row_good_receipt->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmgood_receipt')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $row_good_receipt->ref ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
