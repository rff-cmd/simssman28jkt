					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_siswa_krs_view("", $idtingkat2, $idkelas2, $nis, $semester_id);
                                        ...
                                        <tr>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmsiswa_krs')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('siswa_krs') ?>/<?php echo $siswa_krs_view->nis ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmsiswa_krs')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $siswa_krs_view->nis ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
