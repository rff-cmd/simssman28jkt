...
<table>
	<tr>
        ...
        <td>
			...
			<?php } else { ?>
				<select name="account_code" id="account_code" style="min-width: 178px;" class="chosen-select form-control" onchange="loadHTMLPost4('../app/general_journal_detail_ajax.php','account_code_ajax_<?php echo $i; ?>','getdata','account_code',<?php echo $i; ?>,'<?php echo $ref; ?>','location_id')" >
				<option value=""></option>
				<?php select_finance_type_list("", "out", ""); ?>
			</select>
			<?php } ?>
