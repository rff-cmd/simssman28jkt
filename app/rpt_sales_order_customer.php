					...
					<form class="form-horizontal" role="form" action="" method="post" name="purchase_view" id="purchase_view" class="form-horizontal" enctype="multipart/form-data" >
						...
						<div class="form-group">
		                    ...
		                    <div class="col-sm-3">
		                      ...
		                      &nbsp;
		                      <a class="btn btn-success" href="javascript:void(0);" name="Find" title="Detail" onClick=window.open("<?php echo $__folder ?>app/rpt_sales_order_customer_view.php?from_date=<?php echo $from_date ?>&to_date=<?php echo $to_date ?>&client_code=<?php echo $client_code ?>&status=<?php echo $status ?>&all=<?php echo $all ?>","Find","width=900,height=500,left=200,top=20,toolbar=0,status=0,scroll=1,scrollbars=no"); />
									PRINT
						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th><?php if($lng==1) { echo 'Batch'; } else { echo 'Batch'; } ?></th>
