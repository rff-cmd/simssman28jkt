...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="katalog" id="katalog" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('rak,kode,nama');" >
            	
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
                    	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Rak *)</label>
					<div class="col-sm-4">
						<select name="rak" id="rak" class="chosen-select form-control" >
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kode" name="kode" class="form-control" value="<?php echo $katalog_data->kode ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $katalog_data->nama ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $katalog_data->keterangan ?></textarea>
					</div>
				</div>
