...
<table>
	<tr>
        <td width="370">
			...
			<?php if($ref == "") { ?>
				<select name="account_code" id="account_code" style="min-width: 178px;" class="chosen-select form-control" onchange="loadHTMLPost3('app/general_journal_in_detail_ajax.php','account_code_ajax_<?php echo $i; ?>','getdata','account_code',<?php echo $i; ?>,'<?php echo $ref; ?>')" >
					<option value=""></option>
