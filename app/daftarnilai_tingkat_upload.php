...
<?php
        ...
        if (preg_match("/,/",$datacol) == 0) {
			...
			if($x > 0) {
				...
				$iddasarpenilaian = 3;
				$sqlstr = "select replid, idkelas from siswa where nis='$nis'";
...
<table class="table" align="center" style="font-size: 36px; color: #07581c">
	<tr>
		<td>
			<?php 
				echo "Upload Data Nilai Sukses...<br>"; 
				echo "Finished : ".date("d-m-Y H:i");
			?>				
		</td>
	</tr>
</table>
