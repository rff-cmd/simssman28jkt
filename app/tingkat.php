...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="tingkat" id="tingkat" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('tingkat,tanggal_ttd');" >
