		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_rak=$sql->fetch(PDO::FETCH_OBJ);	
					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="rak" id="rak" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('rak');" >
            	
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
                    	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Rak *)</label>
					<div class="col-sm-3">
						<input type="text" id="rak" name="rak" class="form-control" value="<?php echo $row_rak->rak ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_rak->keterangan ?></textarea>
					</div>
				</div>
