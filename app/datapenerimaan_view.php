<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('datapenerimaan_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_datapenerimaan($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <!--<meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('datapenerimaan_view') ?>" />-->
			<?php
					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_datapenerimaan("", "", "SMA", "");
                                        ...
                                        <tr>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmdatapenerimaan')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('datapenerimaan') ?>/<?php echo $datapenerimaan_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmdatapenerimaan')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $datapenerimaan_view->replid ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
