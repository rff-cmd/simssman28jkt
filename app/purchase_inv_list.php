				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="purchase_view" id="purchase_view" class="form-horizontal" enctype="multipart/form-data" >
						...
						<div class="form-group">
		                    ...
		                    <div class="col-sm-3">
		                    	 <input id="all" name="all" type="checkbox" value="1" class="ace" <?php echo $all2 ?> ><span class="lbl"></span>
							</div>
						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
			                        ...
			                        <th><?php if($lng==1) { echo 'Item Name'; } else { echo 'Nama Barang'; } ?></th>						            <th><?php if($lng==1) { echo 'Date Last Update'; } else { echo 'Terakhir diupdate'; } ?></th>
									<th>Penerimaan</th>
							...
							<tbody>
								...
								?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                            	<?php if( $qty_receipt > 0) { ?>
	                                            	<a href="<?php echo obraxabrix('good_receipt') ?>/<?php echo $row_purchase_inv->ref ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														<span class="green">
