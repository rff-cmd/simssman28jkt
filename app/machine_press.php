	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/machine_press_insert.php"); 
				
				if ($ref != "") {
					$sql=$select->list_machine_press($ref);
					$row_machine_press=$sql->fetch(PDO::FETCH_OBJ);
					
					$ref = $row_machine_press->id;					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="machine_press" id="machine_press" enctype="multipart/form-data" onSubmit="return cekinput('code,name');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="code" name="code" class="form-control" autofocus="" autocomplete="off" value="<?php echo $row_machine_press->code ?>">
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="name" name="name" class="form-control" autocomplete="off" value="<?php echo $row_machine_press->name ?>">
					</div>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="active" id="active" value="1" <?php if($row_machine_press->active==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
					</div>
				</div><!-- /.row -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="uid" name="uid" readonly class="form-control" value="<?php echo $row_machine_press->uid ?>">
					</div>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="dlu" name="dlu" readonly class="form-control" value="<?php echo $row_machine_press->dlu ?>" >
					</div>
				</div><!-- /.form-group -->
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmmachine_press')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmmachine_press')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Save" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmmachine_press')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('machine_press_view') ?>'" />
