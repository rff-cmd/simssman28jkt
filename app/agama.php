		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_agama=$sql->fetch(PDO::FETCH_OBJ);
					
					$ref = $row_agama->replid;					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="agama" id="agama" enctype="multipart/form-data" onSubmit="return cekinput('agama');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="agama" name="agama" class="form-control" autofocus="" autocomplete="off" value="<?php echo $row_agama->agama ?>">
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="urutan" name="urutan" class="form-control" autocomplete="off" value="<?php echo $row_agama->urutan ?>">
					</div>
				</div><!-- /.form-group -->
