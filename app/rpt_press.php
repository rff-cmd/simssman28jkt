					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$selectview->rpt_press($kode, $from_date, $to_date, $client_code, $status, $all);
								...
								?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0);" name="Find" title="Detail" onClick=window.open("<?php echo $__folder ?>app/rpt_press_detail.php?ref=<?php echo $row_sales_order->ref ?>","Find","width=900,height=500,left=200,top=20,toolbar=0,status=0,scroll=1,scrollbars=no"); />
													<span class="green">
