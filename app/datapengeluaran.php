		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_datapengeluaran=$sql->fetch(PDO::FETCH_OBJ);	
					
					if ($row_datapengeluaran->aktif == 1) {
						$aktif = "checked";
					} else {
						$aktif = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="datapengeluaran" id="datapengeluaran" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('nama,rekdebet,rekkredit');" >
            	
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
            	<input type="hidden" id="departemen" name="departemen" value="SMA" >
            	<input type="hidden" id="oldnama" name="oldnama" value="<?php echo $row_datapengeluaran->nama ?>" >
				<input type="hidden" id="olddepartemen" name="olddepartemen" value="<?php echo $row_datapengeluaran->departemen ?>" >
                
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama *)</label>
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $row_datapengeluaran->nama ?>">
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="rekdebet" id="rekdebet" class="chosen-select form-control"  />
							<option value=""></option>
							<?php select_rekakun('HARTA', $row_datapengeluaran->rekdebet); ?>
						</select>
					</div>
				</div>
				
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Rekening Beban *)</label>
					<div class="col-sm-3">
						<select name="rekkredit" id="rekkredit" class="chosen-select form-control" />
							<option value=""></option>
							<?php select_rekakun('BIAYA', $row_datapengeluaran->rekkredit); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_datapengeluaran->keterangan ?></textarea>
					</div>
				</div>
