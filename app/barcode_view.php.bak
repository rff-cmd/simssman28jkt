...
<table class="table" border="0" width="20%" cellspacing="0" style="font-family: arial; font-size: 8px; border: 1px solid #ccc">
	
	
	<tr>
		<td align="center" rowspan="3">
			<img src="http://4.bp.blogspot.com/-6l53wRP09ME/UNOStdi3FcI/AAAAAAAAEJs/67PYX5s2EBo/s1600/Logo+DKI+Jakarta.jpg" height="70" width="80" >
		</td>
		
		<td colspan="3" align="center" style="font-size: 16px"><?php echo $namasekolah ?></td>
		
		<td align="center" rowspan="3">
			<img src="../assets/img/bandung.png" height="70" width="70" >
		</td>		
	</tr>
