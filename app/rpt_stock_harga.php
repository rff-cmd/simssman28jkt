...
<table class="table" width="<?php echo $width ?>" border="1" cellspacing="5" style="font-family: sans-serif; ">
	...
	?>
				...
				<td valign="top" style="border: 1px solid #000000">
					<table class="table" width="100%" border="0" style="font-family: sans-serif; font-size: 16px">
	...
	?>
				<?php /*
				<td valign="top" style="border: 1px solid #000000">
					<table class="table" width="100%" border="1" style="font-family: sans-serif; font-size: 14px">
						<tr style="font-weight: bold;">
