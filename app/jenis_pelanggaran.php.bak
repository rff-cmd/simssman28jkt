		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_jenis_pelanggaran=$sql->fetch(PDO::FETCH_OBJ);	
					
					if ($row_jenis_pelanggaran->aktif == 1) {
						$act = "checked";
					} else {
						$act = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="jenis_pelanggaran" id="jenis_pelanggaran" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('nama');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $row_jenis_pelanggaran->nama ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="poin" name="poin" class="form-control" onkeyup="formatangka('poin')" value="<?php echo $row_jenis_pelanggaran->poin ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php if($row_jenis_pelanggaran->aktif==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
