		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_setup_periode_raport_pts($segmen4);
			?>
					<div class="alert alert-success">
						<strong>Delete Data successfully</strong>
					</div>
                    
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('setup_periode_raport_pts_view') ?>" />
			<?php
					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$select->list_setup_periode_raport_pts("", $idtahunajaran, $semester_id, $tingkat_id, $all);
								...
								?>
                                        ...
                                        <tr>
											...
											<td align="center">
                                                ...
                                                <?php if (allowupd('frmsetup_periode_raport_pts')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('setup_periode_raport_pts') ?>/<?php echo $setup_periode_raport_view->replid ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmsetup_periode_raport_pts')==1) { ?>    
                                                    &nbsp;
