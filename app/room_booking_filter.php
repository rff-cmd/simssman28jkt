...
<?php
	...
	$from_time		=	date("H:i");
	$to_time		=	date("H:i");
	$to_time 		=	date('H:i',strtotime('+30 minutes',strtotime($to_time)));
?>
...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="<?php echo obraxabrix('room_booking') ?>" method="post" name="registration2" id="registration2" enctype="multipart/form-data" onSubmit="return cekinput('registrationid');" >
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="submit" name="submit" id="submit" class='btn btn-primary' value="Tampilkan Ruang"/>
