				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="besarjtt_view" id="besarjtt_view" enctype="multipart/form-data" >
						...
						<div class="form-group">
		                    ...
		                    <div class="col-sm-3">
		                    	 <select name="idkategori" id="idkategori" class="chosen-select form-control" onchange="loadHTMLPost3('app/besarjtt_ajax.php','id_penerimaan','getkategori','idkategori', 'departemen')" />
									<option value=""></option>
						...
						<div class="form-group">
		                    ...
		                    <div class="col-sm-3" id="id_penerimaan">
		                    	<select name="idpenerimaan" id="idpenerimaan" class="chosen-select form-control" />
									<option value=""></option>
									<?php select_datapenerimaan($idkategori, "SMA", $idpenerimaan); ?>
								</select>
							</div>
				...
				<div class="col-xs-12">
					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$sql=$selectview->list_siswabesarjtt('', '', $idtingkat2, $idkelas2, $nama2, $all, $idkategori, $idpenerimaan, $idangkatan, "SMA");
									while($besarjtt_view=$sql->fetch(PDO::FETCH_OBJ)){
										...
										$sqlbesarjtt=$selectview->list_besarjtt($nis, $idpenerimaan, "SMA");													while($besarjtt=$sqlbesarjtt->fetch(PDO::FETCH_OBJ)) {
								...
								?>
                                        ...
                                        <tr>
											...
											<td><?php echo $besarjtt_view->nisn ?></td>
											<td><?php echo $besarjtt_view->nama ?></td>
											<td><?php echo $kelamin ?></td>
											<td><?php echo $besarjtt_view->tingkat ?></td>
											<td <?php echo $bgcolor ?>><?php echo $besarjtt_view->kelas ?></td>
