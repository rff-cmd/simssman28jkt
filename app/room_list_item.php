	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="client_cheque" id="client_cheque" enctype="multipart/form-data" onSubmit="return cekinput('ref,item_code');" >
            	...
            	<table class="table" class="table table-bordered table-condensed table-hover table-striped" >
					<thead>
					...
					<tbody>
						<tr> 
							...
							<td class="col-sm-3"><input type="text" id="qty" name="qty" class="form-control" onkeyup="formatangka('qty')" value="<?php echo $row_client_bank->qty ?>"></td>
							<td align="center">
