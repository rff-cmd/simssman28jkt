		                        ...
		                        <?php if ($ref=='') { ?>
		                          <select id="client_code" name="client_code" data-placeholder="..." class="chosen-select form-control" style="width: auto" onChange="loadHTMLPost2('app/receipt_ajax.php','invoicedetail','getinvoice','client_code')">
		                            ...
		                            <?php 
										...
										select_contact3($client_code);
		                            ?>                   
		                          </select>
		                        <?php } else { ?>
		                        	<input type="hidden" id="client_code" name="client_code" class="form-control" readonly value="<?php echo $client_code ?>">
            			...
            			<td>&nbsp;</td>
			             ...
			             <td>
			             	...
			             	<div class="form-group">
		                        ...
		                        <div class="col-sm-3">
		                          <select id="currency_code" name="currency_code" data-placeholder="..." class="fchosen-select form-control" style="width: auto">
		                            <option value=""></option>
		                            <?php 
