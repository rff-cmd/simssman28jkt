		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$ekstra_sifat = "";
					if ($jeniskompetensi_data->ekstra_sifat == 1) {
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="jeniskompetensi2" id="jeniskompetensi2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('jeniskompetensi');" >
            	
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
            	
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Kompetensi *)</label>
					<div class="col-sm-3">
						<input type="text" name="jeniskompetensi" id="jeniskompetensi" class="form-control" value="<?php echo $jeniskompetensi_data->jeniskompetensi ?>">
					</div>
				</div>
