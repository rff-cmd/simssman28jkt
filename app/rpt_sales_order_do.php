						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
                                    ...
                                    <th><?php if($lng==1) { echo 'Ref No'; } else { echo 'No. PO'; } ?></th>
							...
							<tbody>
                                <?php			
									$i = 0;
            						$sql=$selectview->rpt_sales_order_do($kode, $from_date, $to_date, $client_code, $status, $all);
								...
								?>
                                        ...
                                        <tr>
											...
											<td><?php echo date("d-m-Y H:i:s", strtotime($row_sales_order->dlu)) ?></td>
											
											
                                            <!--<td><?php echo $row_sales_order->type ?></td>
                                            <td align="center"><?php if ($row_sales_order->active == 1) { ?>
                                                    <button class="btn btn-xs btn-success">
														<i class="ace-icon fa fa-check bigger-120"></i>
													</button><?php } ?>
                                            </td>
                                            <td><?php echo $row_sales_order->uid ?></td>
                    						<td><?php echo $row_sales_order->dlu ?></td>-->
                    						
                                            <td>
                                            
                                                <a href="javascript:void(0);" name="Find" title="Detail" onClick=window.open("<?php echo $__folder ?>app/rpt_sales_order_do_view.php?ref=<?php echo $row_sales_order->ref ?>","Find","width=900,height=500,left=200,top=20,toolbar=0,status=0,scroll=1,scrollbars=no"); />
													<span class="green">
