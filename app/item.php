	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				$ref2 = notran(date('Y-m-d'), 'frmitem', '', '', ''); 
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="item" id="item" enctype="multipart/form-data" onSubmit="return cekinput('code,name,client_code');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3" id="code_item">
						<input type="text" id="code" name="code" autofocus="" autocomplete="off" onblur="loadHTMLPost3('app/item_ajax_code.php','code_item','cekcode_item','syscode','code')" class="form-control" readonly="" value="<?php echo $ref2 ?>">
					</div>
				</div>
				...
				<!--<div class="form-group">
					...
					<div class="col-sm-3" id="barcode_id">
						<input type="text" id="old_code" name="old_code" autocomplete="off" onblur="loadHTMLPost3('app/item_ajax_code.php','barcode_id','barcode_item','syscode','old_code')" class="form-control" value="<?php echo $row_item->old_code ?>">
					</div>
				</div>-->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="name" name="name" class="form-control" autocomplete="off" value="<?php echo $row_item->name ?>">
					</div>
				</div>
				
				<div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Client'; } else { echo 'Customer'; } ?> *)</label>
                    <div class="col-sm-3">
                      <select id="client_code" name="client_code" class="chosen-select form-control" style="width: auto">
                        <option value=""></option>
                        <?php 
                        	combo_select_active("client","syscode","name","active","1",$row_item->client_code) 
                        ?>	                            
                      </select>
					</div>
				</div>
				...
				<div class="form-group"> 
                    ...
                    <div class="col-xs-5">
        				...
        				<?php if (!empty($row_item->photo)) { ?>
        					<img src="../app/photo_item/<?php echo $row_item->photo; ?>" width="150" height="150" />
        				<?php } ?>
                        <input type="hidden" id="photo2" name="photo2" value="<?php echo $row_item->photo; ?>">  
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						<?php if (allowadd('frmitem')==1) { ?>
	                      &nbsp;&nbsp;&nbsp;
						  <input type="button" name="submit" id="submit" class="btn btn-success" value="Tambah Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('item') ?>'" />
					    <?php } ?>
