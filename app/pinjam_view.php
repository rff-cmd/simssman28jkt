								...
								<div>
									...
									<table class="table" border="0">
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>
												<!-- <input type="text" name="tglpinjam" id="tglpinjam" class='datepick' style="min-width: 178px;  font-size: 12px" value="<php echo $tglpinjam ?>" > -->
										...
										<tr>
											...
											<td>
												<div class="col-sm-6">
													<!-- <input type="text" name="tglkembali" id="tglkembali" class='datepick' style="min-width: 178px;  font-size: 12px" value="<php echo $tglkembali ?>" > -->
