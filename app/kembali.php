								...
								<div>
									...
									<table class="table" border="0">
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="denda" id="denda" onkeyup="formatangka('denda')" style="width:120px; text-align: right; " value="<?php echo $denda ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<!-- <input type="text" name="keterangan" id="keterangan" style="width:250px; " value="<php echo $keterangan ?>"> -->
