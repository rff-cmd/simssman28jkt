	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/division_insert.php"); 
				
				if ($ref != "") {
					$sql=$select->list_division($ref);
					$row_division=$sql->fetch(PDO::FETCH_OBJ);							
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="division" id="division" enctype="multipart/form-data" onSubmit="return cekinput('name');" >
			
				<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
                
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Division Name'; } else { echo 'Nama Divisi'; } ?> *)</label>
					<div class="col-sm-3">
						<input type="text" id="name" name="name" class="form-control" style="width: 300px" value="<?php echo $row_division->name ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="active" id="active" value="1" <?php if($row_division->active==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
					</div>
				</div><!-- /.row -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="uid" name="uid" readonly class="form-control" style="width: 300px" value="<?php echo $row_division->uid ?>">
					</div>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="dlu" name="dlu" readonly class="form-control" style="width: 300px" value="<?php echo $row_division->dlu ?>" >
					</div>
				</div><!-- /.form-group -->
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmdivision')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmdivision')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Save" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frmdivision')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('division_view') ?>'" />
