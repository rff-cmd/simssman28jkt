...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="penerimaanjtt_update" id="penerimaanjtt_update" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('idpenerimaan,departemen');" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idangkatan1" id="idangkatan1" disabled="" class="chosen-select form-control" >
							<?php select_thnajaran($idangkatan); ?>
						</select>
						<input type="hidden" id="idangkatan" name="idangkatan" value="<?php echo $idangkatan ?>" />
					</div>
				</div>
				
				<?php /*<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Semua Siswa</label>
					<div class="col-sm-3">
						<input type="checkbox" name="semua" id="semua" class="ace" value="1" ><span class="lbl"></span><i style="font-size: 11px; color: #ff0000">*) Jika dichecklist, maka semua siswa dengan tingkat dan kelas tersebut akan diseting.</i>
					</div>
				</div>*/ ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idkategori1" id="idkategori1" class="chosen-select form-control" disabled="" onClick="loadHTMLPost2('app/besarjtt_ajax.php','id_penerimaan','getkategori','idkategori','departemen')" />
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-3" id="id_penerimaan">
						<select name="idpenerimaan1" id="idpenerimaan1" disabled="" class="chosen-select form-control" >
							<option value=""></option>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="jumlah" id="jumlah" class="form-control" onkeyup="formatangka('jumlah')" value="<?php echo number_format($besarjtt_data->jumlah,'0','.',',') ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Besar Cicilan</label>
					<div class="col-sm-3">
						<input type="text" name="cicilan" id="cicilan" class="form-control" onkeyup="formatangka('cicilan')" readonly="" value="<?php echo number_format($besarjtt_data->besar,'0','.',',') ?>">
					</div>
				</div>
				
				<?php /*<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Potongan/Beasiswa</label>
					<div class="col-sm-3">
						<input type="text" name="potongan" id="potongan" class="form-control" onkeyup="formatangka('potongan')" value="<?php echo number_format($besarjtt_data->potongan,'0','.',',') ?>">
					</div>
				</div>*/ ?>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="tgljurnal" id="tgljurnal" class="form-control" readonly value="<?php echo $tgljurnal ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $besarjtt_data->keterangan ?></textarea>
					</div>
				</div>
