...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="rpp2" id="rpp2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('idtingkat,idsemester,idpelajaran,idguru,koderpp,deskripsi');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idtingkat" id="idtingkat" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_tingkat($rpp_data->idtingkat) ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idsemester" id="idsemester" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_semester("SMA", $rpp_data->idsemester) ?>
						</select>
					</div>
				</div>
