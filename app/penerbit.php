...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="penerbit" id="penerbit" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('kode,nama');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kode" name="kode" class="form-control" value="<?php echo $penerbit_data->kode ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $penerbit_data->nama ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="alamat" name="alamat" class="form-control"><?php echo $penerbit_data->alamat ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="telpon" name="telpon" class="form-control" value="<?php echo $penerbit_data->telpon ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="email" name="email" class="form-control" value="<?php echo $penerbit_data->email ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kontak" name="kontak" class="form-control" value="<?php echo $penerbit_data->kontak ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $penerbit_data->keterangan ?></textarea>
					</div>
				</div>
