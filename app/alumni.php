	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_alumni.php");
				...
				if ($ref != "") {
					...
					//get tgl lulus
					$sqlalumni = $selectview->list_alumni($nis);
					$data_alumni = $sqlalumni->fetch(PDO::FETCH_OBJ);
					$tgllulus = date("d-m-Y", strtotime($data_alumni->tgllulus));
							...
							<div class="widget-main">
								<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="tgllulus" name="tgllulus" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $tgllulus ?>">
										</div>
									</div>
				...
				<div class="col-sm-12">
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							...
							&nbsp;
							<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('alumni_list') ?>'" />
