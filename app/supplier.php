									...
									<table class="table" border="0">
										...
										<?php if($ref != "") { ?>
											<tr>
												...
												<td>&nbsp;&nbsp;</td>
												<td>:</td>
												<td><input type="text" name="kode" id="kode" readonly="" style="width:250px; " value="<?php echo $supplier_data->kode ?>"></td>
											</tr>
										<?php } ?>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $supplier_data->nama ?>">
											</td>
										</tr>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" id="alamat" name="alamat" class="form-control" value="<?php echo $supplier_data->alamat ?>">
											</td>
										</tr>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" id="telepon" name="telepon" class="form-control" value="<?php echo $supplier_data->telepon ?>">
											</td>
										</tr>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" id="hp" name="hp" class="form-control" value="<?php echo $supplier_data->hp ?>">
											</td>
										</tr>
