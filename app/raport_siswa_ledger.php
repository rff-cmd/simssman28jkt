...
<script>
	function ledger_preview() {
		...
		window.open('<?php echo $__folder ?>app/raport_siswa_ledger_view.php?semester_id='+semester_id+'&idtingkat='+idtingkat+'&idkelas='+idkelas+'&kelamin='+kelamin+'&nama='+nama+'&nis='+nis+'&nik='+nik+'&all='+all+'&idtahunajaran2='+idtahunajaran2, 'Raport Siswa Ledger View','825','450','resizable=1,scrollbars=1,status=0,toolbar=0');								
	}
					...
					<form class="form-horizontal" role="form" action="" method="post" name="siswa_lis" id="siswa_list" enctype="multipart/form-data" >
		            	...
		            	<div class="form-group">
							...
							<div class="col-sm-3">
								...
								<?php } else { ?>
									<input type="hidden" id="idtingkat2" name="idtingkat2" value="<?php echo $idtingkat2 ?>" />
									<select name="idtingkat2_" id="idtingkat2_" disabled="" class="chosen-select form-control"  >
										<?php select_tingkat_unit("SMA", $idtingkat2); ?>
									</select>	
								<?php } ?>							
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3" id="kelas_id">
								...
								<?php } else { ?>
									<input type="hidden" id="idkelas2" name="idkelas2" value="<?php echo $idkelas2 ?>" />
									<select name="idkelas2_" id="idkelas2_" disabled="" class="chosen-select form-control" >
										<?php select_kelas($idtingkat2, $idkelas2); ?>
									</select>
								<?php } ?>						
							</div>
