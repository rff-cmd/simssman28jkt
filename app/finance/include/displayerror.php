...
if ($_SESSION['errno'] != 0) 
{
	...
	$html1 .= "<table class="table" border='0' width='100%' height='100%'>\r\n";
	...
	$html1 .= "<table class="table" width='457' border='0' cellpadding='0' cellspacing='0'><tr><td><img src='". $rel ."images/bk_message_01.jpg' width='457' height='17'></td></tr><tr><td style='background-image:url(". $rel ."images/bk_message_02.jpg); padding-left:20px; padding-right:20px;'>\r\n";
	...
	else 
	{
		...
		$errstr .= "<table class="table" border='1' cellpadding='0' cellspacing='0' style='border-width: 1px; border-collapse: collapse' width='100%'>\r\n";
		$errstr .= "<tr>\r\n";
