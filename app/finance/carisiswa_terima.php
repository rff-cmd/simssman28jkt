		    ...
		    <table class="table" border="0" cellpadding="0" cellspacing="0" width="100%">
			    ...
			    <tr>
			    	...
			    	<td align="left" width="50%">
			        	<select name="idtingkat" id="idtingkat" style="min-width: 250px; height:27px; "  >
							<option value="">...</option>
			    ...
			    <tr>
			    	...
			    	<td align="left" width="1%"><strong>:</strong></td>
			    	<td align="left" width="50%">
			        	<select name="idkelas" id="idkelas" style="min-width: 250px; height:27px; "  >
							<option value="">...</option>
...
?>
	...
	<table class="table" class="tab" id="table" border="1" style="border-collapse:collapse" width="100%" align="left" bordercolor="#000000">
