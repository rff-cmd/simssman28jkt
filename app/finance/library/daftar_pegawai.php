...
<table class="table" border="0" width="100%" cellpadding="2" cellspacing="2" align="center">
<tr>
    <td>
...
<tr>
	...
	?>
    <!--<div id="tab_daftar">-->
    <table class="table" width="100%" id="table" class="tab" border="1" align="center" cellpadding="2" cellspacing="0">
...
<tr>
    <td>
    <table class="table" border="0"width="100%" align="center"cellpadding="0" cellspacing="0">	
    <tr>
...
<?php } else { ?>    		
	<table class="table" width="100%" align="center" cellpadding="2" cellspacing="0" border="0" id="table">
