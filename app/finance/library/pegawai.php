...
<title>SIAS - SIMAKA [Daftar Pegawai]</title>
...
function pilih(nip, nama) {
	...
	opener.acceptPegawai(nip, nama, <?php echo $flag ?>);
...
<tr height="58">
    ...
    <td width="*" background="../<?php echo GetThemeDir() ?>bgpop_02a.jpg">&nbsp;</td>
...
<tr height="150">
    ...
    <!-- CONTENT GOES HERE //--->
    <table class="table" border="0" cellpadding="0" bgcolor="#FFFFFF" cellspacing="0" width="100%" >
    <tr height="500">
...
//alert ('bagian <?php echo $bagian?>');
sendRequestText("daftar_pegawai.php", show_panel0, "bagian=<?php echo $bagian?>");
sendRequestText("cari_pegawai.php", show_panel1, "bagian=<?php echo $bagian?>");
...
function change_page(page, tipe) {
	...
	//document.location.href="pegawai.php?bagian="+bagian+"&page="+page+"&hal="+page+"&urut=<?php echo $urut?>&urutan=<?php echo $urutan?>&varbaris="+varbaris;
}
...
function change_baris(tipe) {
	...
	//document.location.href="pegawai.php?bagian="+bagian+"&urut=<?php echo $urut?>&urutan=<?php echo $urutan?>&varbaris="+varbaris;
}
...
function change_urut(urut,urutan,tipe) {
	...
	//document.location.href="pegawai.php?bagian="+bagian+"&urut="+urut+"&urutan="+urutan+"&page=<?php echo $page?>&hal=<?php echo $hal?>&varbaris="+varbaris;
}
