...
<title>SIAS - SIMAKA [Daftar Siswa]</title>
...
function pilih(nis, nama) {	
	opener.acceptSiswa(nis, nama, <?php echo $flag?>);
	window.close();
}
...
sendRequestText("pilih_siswa.php", show_panel0, "departemen=<?php echo $departemen?>&tahunajaran=<?php echo $tahunajaran?>&tingkat=<?php echo $tingkat?>");
sendRequestText("cari_siswa.php", show_panel1, "departemen=<?php echo $departemen?>");
