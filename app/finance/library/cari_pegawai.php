...
OpenDb();
?>
<table class="table" border="0" width="100%" cellspacing="2" align="center">
<tr>
	<td colspan="2">
...
<tr>
   ...
   <input type="button" class="but" name="submit" id="submit" value="Cari" onclick="carilah();"  style="min-width: 178px;height:40px"/>
   </td>
</tr>
<tr>
...
if (isset($_REQUEST['submit']) || $_REQUEST['submit'] == 1) { 
    ...
    <table class="table" width="100%" class="tab" cellpadding="2" cellspacing="0" id="table1" border="1" align="center">
...
<?php } CloseDb(); ?>
    ...
    <table class="table" border="0"width="100%" align="center"cellpadding="2" cellspacing="2">
    <tr>
...
<?php } else { ?>    		
	<table class="table" width="100%" align="center" cellpadding="2" cellspacing="0" border="0" id="table1">
