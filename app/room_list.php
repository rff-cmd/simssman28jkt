...
<script type="text/javascript">
	...
	function room_item(ref) {
		window.open("app/room_list_item.php?ref="+ref,"Find","width=1000,height=620,left=50,top=10,toolbar=0,status=0,scroll=1,scrollbars=no");
	}
</script>

<script>
	function print_material(ref) {
		/*var old_code	=	document.getElementById('old_code').value;
		var name		=	document.getElementById('name').value;
		var item_group_id	=	document.getElementById('item_group_id').value;
		var asset_ref	=	document.getElementById('asset_ref').value;
		var ref			=	document.getElementById('ref').value;
		var all			=	document.getElementById('all').checked;*/
		
		//window.open('app/rpt_material_print.php?old_code='+old_code+'&name='+name+'&item_group_id='+item_group_id+'&asset_ref='+asset_ref+'&ref='+ref, 'Invoice Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
		window.open('app/rpt_material_print.php?ref='+ref, 'Invoice Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
</script>
		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="room_view" id="room_view" class="form-horizontal" enctype="multipart/form-data" >
            	...
            	<div class="form-group">
                    ...
                    <div class="col-sm-3" id="room_filter">
							...
							<tbody>
								...
								?>
                                        ...
                                        <tr>
					                    	...
					                    	<td align="center">
												<a href="javascript:void(0);" name="Find" title="Data Inv." onClick="room_item('<?php echo $row_room->ref ?>')"><img src="assets/img/plus.png" /></a>
											</td>
				                            <td>
											...
											<td align="center">
												<a href="JavaScript:print_material('<?php echo $row_room->ref ?>')" class="tooltip-error" data-rel="tooltip" title="Cetak">
					                            	<?php echo $data_machine->machine_name; ?>&nbsp;
													<span class="green">
