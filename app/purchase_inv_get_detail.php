<?php
 ...
 <table class="table" class="table table-bordered table-condensed table-hover table-striped" style="width: auto; font-size: 11px">
	<thead>
		<tr> 
			<th>No.</th>
	...
	<tbody>
		...
		?>								
				...
				<tr style="background-color:ffffff;" id="item_ajax2_<?php echo $no; ?>" > 
					...
					<td>				
						<?php echo $row_purchase_inv_detail->code; ?>
						<input type="hidden" id="item_code2_<?php echo $no ?>" name="item_code2_<?php echo $no ?>" class="form-control" readonly="" style="width: 80px" value="<?php echo $row_purchase_inv_detail->code; ?>" >
						
					</td>
					
					<td>				
						<?php echo $row_purchase_inv_detail->item_name; ?>
						<input type="hidden" id="item_name_<?php echo $no ?>" name="item_name_<?php echo $no ?>" class="form-control" readonly="" style="width: 270px" value="<?php echo $row_purchase_inv_detail->item_name; ?>" >
					...
					<td>
						<input type="text" id="size_<?php echo $no ?>" name="size_<?php echo $no ?>" class="form-control" readonly="" style="width: 60px" value="<?php echo $size; ?>" >		
					</td>
					<td align="center">
					...
					*/ ?>
					...
					<td align="center">
						<a href="JavaScript:update('<?php echo $row_purchase_inv_detail->ref ?>','<?php echo $no ?>')"><img src="<?php echo $__folder ?>assets/img/check.png" ></a>
					</td>
					
					<td align="center">
						<!--<input type="checkbox" id="delete_<?php echo $no; ?>" name="delete_<?php echo $no; ?>" class="form-control" value="1" >-->
						<a href="JavaScript:hapus('<?php echo $row_purchase_inv_detail->ref ?>','<?php echo $row_purchase_inv_detail->line ?>')"><img src="<?php echo $__folder ?>assets/img/delete.png" ></a>
					</td>
			...
			<tr>
				<td colspan="7" align="right" style="font-size: 14px; font-weight: bold;">Discount&nbsp;</td>
				<td align="center">
			...
			<tr>
				<td colspan="9" align="right" style="font-size: 14px; font-weight: bold;">Total Pajak&nbsp;</td>
			...
			<tr>
				<td colspan="9" align="right" style="font-size: 14px; font-weight: bold;">Total&nbsp;</td>
			...
			<!-- <tr> -->
				...
				<td align="right"> -->
					<input type="hidden" id="cash_amount" name="cash_amount" autocomplete="off" style="text-align: right; font-size: 14px; font-weight: bold; width: 150px" class="form-control" onkeyup="formatangka('cash_amount'), sub_total('<?php echo $jmldata ?>')" value="<?php echo $cash_amount ?>" >
				<!-- </td>
			</tr> -->
			...
			<!-- <tr>
				<td colspan="9" align="right" style="font-size: 14px; font-weight: bold;">Kembalian&nbsp;</td>
