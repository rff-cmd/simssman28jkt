						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									...
									$sql=$selectview->list_sales_invoice($ref, $client_code, $from_date, $to_date, $location_id, $all, $cashier);			
								...
								?>
                                        ...
                                        <tr>
				                            ...
				                            <td>
				                            	...
				                            	<table class="table" width="100%" border="1" style="border: 1px solid #93d145">
				                            		...
				                            		<tr>
				                            			...
				                            			<td align="center"><?php echo number_format($row_pos_det->qty,2,".",",") ?></td>
				                            			<td align="right"><?php echo number_format($row_pos_det->unit_price,2,".",",") ?></td>
				                            			<td align="right"><?php echo number_format($row_pos_det->amount,2,".",",") ?></td>
				                            		</tr>
				                            		<?php
					                    	...
					                    	<td align="right"><?php echo number_format($row_sales->total,2,".",",") ?></td>
					                    	<td>
