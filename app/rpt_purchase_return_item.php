						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th>Supplier</th>
									<th><?php if($lng==1) { echo 'Tax Rate (%)'; } else { echo 'Pajak (%)'; } ?></th>									
							...
							<tbody>
                                <?php			
									...
									while($row_purchase_return=$sql->fetch(PDO::FETCH_OBJ)){
			                                ...
			                                $tax_amount = ($row_purchase_return->tax_rate * $row_purchase_return->amount)/100;
								...
								?>
                                        ...
                                        <tr>
						                    ...
						                    <td align="right"><?php echo $row_purchase_return->tax_rate ?></td>
						                    <td align="right"><?php echo $tax_amount ?></td>
											<!--<td><?php echo $row_purchase_return->memo ?></td>-->
				                            <td>
				                            	<?php //echo $item_name ?>
				                            	
				                            	<table class="table" border="1" style="border: 1px solid #93d145">
				                            		<?php 
				                            			$sql2=$select->list_purchase_return_detail($row_purchase_return->ref); 
				                            			while($row_purchase_return_det=$sql2->fetch(PDO::FETCH_OBJ)) {	
				                            		?>
				                            		<tr>
				                            			<td><?php echo $row_purchase_return_det->item_name ?></td>
				                            			<td align="center"><?php echo $row_purchase_return_det->qty ?></td>
				                            			<td align="right"><?php echo $row_purchase_return_det->unit_cost ?></td>
				                            		</tr>
				                            		<?php
														}
				                            		?>
                                            ...
                                            <td>
                                                ...
                                                <?php if (allowupd('frmpurchase_return_quick')==1) { ?>
