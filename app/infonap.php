	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_infonap.php");
				
				if ($ref != "") {
					$sql=$select->list_infonap($ref);
					$row_infonap=$sql->fetch(PDO::FETCH_OBJ);	
					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="infonap" id="infonap" enctype="multipart/form-data" onSubmit="return cekinput('idpelajaran');" >
				...
				<div class="form-group">
					...
					<div class="col-lg-4">
						<select name="idpelajaran" id="idpelajaran" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_pelajaran_all($row_infonap->idpelajaran); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" id="nilaimin" name="nilaimin" class="form-control" onkeyup="formatangka('nilaimin')" value="<?php echo number_format($row_infonap->nilaimin,0,'.',',') ?>">
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frminfonap')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frminfonap')==1) { ?>
    						<?php if($ref=='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Simpan" />
    						<?php } ?>
                        <?php } ?>
                        
                        <?php if (allowdel('frminfonap')==1) { ?>
                            &nbsp;
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('infonap_view') ?>'" />
