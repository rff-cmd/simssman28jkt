...
<script>
	function hapus_bank(id, line) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "jadwal_update.php?idjadwal="+id+"&mxKz=xm8r389xemx23xb2378e23&id="+id+"&line="+line+" ";
		}
	}
</script>
		...
		<div class="col-xs-12">
            ...
            <?php
				...
				if ($delete == "xm8r389xemx23xb2378e23") {
					...
					$delete2=new delete;
					$delete2->delete_jadwal($idjadwal);
			?>
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="jadwal_update" id="jadwal_update" enctype="multipart/form-data" onSubmit="return cekinput('date');" >
