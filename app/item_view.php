<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix(item_view) ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
				...
				<div class="col-xs-12">
					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php
									$sql=$select->list_item($kode, $all, $active, $code, $old_code, $name, $client_code);
								...
								?>
                                        ...
                                        <tr>
					                    	...
					                    	<td><?php echo $row_item->client_name ?></td>
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmitem')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('item') ?>/<?php echo $row_item->syscode ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
