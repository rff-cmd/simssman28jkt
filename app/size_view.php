<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "<?php echo $__folder ?><?php echo obraxabrix('size_view') ?>/xm8r389xemx23xb2378e23/"+id+" ";
		}
	}
</script>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			?>
                    ...
                    <meta http-equiv="Refresh" content="0;url=<?php echo $__folder ?><?php echo obraxabrix('size_view') ?>" />
			<?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if (allowupd('frmsize')==1) { ?>
    												<a href="<?php echo $__folder ?><?php echo obraxabrix('size') ?>/<?php echo $row_size->id ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
