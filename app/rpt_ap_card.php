						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
                                    ...
                                    <th><?php if($lng==1) { echo 'Transaction'; } else { echo 'Transaksi'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Invoice No.'; } else { echo 'No. Nota'; } ?></th>
			                    	
			                    	<th><?php if($lng==1) { echo 'Debit'; } else { echo 'Debet'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Credit'; } else { echo 'Kredit'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Balance'; } else { echo 'Saldo'; } ?></th>
