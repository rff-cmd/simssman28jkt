				...
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="rpt_presensi_harian_siswa" id="rpt_presensi_harian_siswa" class="form-horizontal" enctype="multipart/form-data" >
		            	...
		            	<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="daritgl" name="daritgl" style="font-size: 12px" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $daritgl ?>">								
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="ketgl" name="ketgl" style="font-size: 12px" class="form-control date-picker" data-date-format="dd-mm-yyyy" autocomplete="off" value="<?php echo $ketgl ?>">								
							</div>
						</div>
						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="font-weight:bold ">Tingkat-Kelas &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Tanggal &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Jam &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Pelajaran &nbsp;&nbsp;</th>
									<th style="font-weight:bold ">Guru Pelajaran &nbsp;&nbsp;</th>
								</tr>
							</thead>
							...
							<tbody>
                                <?php			
									$i = 0;
            						$total = 0;													
									$sql=$selectview->rpt_presensi_pelajaran_siswa($daritgl, $ketgl, $nis, $idkelas, $idtingkat, $nama, $departemen);												
								...
								?>
                                        ...
                                        <tr>
											...
											<td><?php echo $rpt_presensi_harian_siswa_view->jam ?></td>
											<td><?php echo $rpt_presensi_harian_siswa_view->pelajaran ?></td>
											<td><?php echo $rpt_presensi_harian_siswa_view->guru ?></td>
