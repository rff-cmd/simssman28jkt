...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="buku_kunjungan" id="buku_kunjungan" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('ref,tanggal,nama,nohp,keperluan');" >
            	...
            	<div class="row">
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Guest Name'; } else { echo 'Nama Pengunjung'; } ?> *)</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'No HP'; } else { echo 'No HP'; } ?> *)</label>
								<div class="col-sm-5">
									<input type="text" id="nohp" name="nohp" class="form-control" value="<?php echo $row_buku_kunjungan->nohp ?>"> 
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Institute'; } else { echo 'Jabatan/Instansi'; } ?> *)</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Keperluan'; } else { echo 'Keperluan'; } ?> *)</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Description'; } else { echo 'Kesan dan Pesan'; } ?> *)</label>
								<div class="col-sm-5">
					...
					<div class="col-sm-6">
						<div class="row">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Memo'; } else { echo 'Keterangan'; } ?> *)</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php if($lng==1) { echo 'Sign'; } else { echo 'Tanda Tangan'; } ?></label>
								<div class="col-sm-3">
									<?php if($ref=='') { ?>
