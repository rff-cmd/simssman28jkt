			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div>
						...
						<?php
							$sqlso=$selectview->rpt_sewing($ref);
						...
						<table class="table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
		                        	...
		                        	<td align="center">Kode Artikel</td>
		                        	<td align="center">Artikel</td>
		                        	<td align="center">Ukuran</td>
		                        	<td align="center">Jumlah PO</td>
		                        	<td align="center">Jumlah Printing</td>
		                        	<td align="center">Jumlah Press</td>
		                        	<td align="center">Jumlah Jahit</td>
		                        	<td align="center">Jumlah Cacat Print</td>
		                        	<td align="center">Jumlah Cacat Press</td>
		                        	<td align="center">Jumlah Cacat Counting</td>
		                        </tr>
	                       </thead>
	                      	...
	                      	<?php
	    						...
	    						$sql=$selectview->rpt_sewing_detail($ref);
	    					...
	    					?>
	    	                    ...
	    	                    <tr>
	    	                    	...
	    	                    	<td align="center"><?php echo number_format($row_item->qty_so,0,'.',',') ?></td>
	    	                    	<td align="center"><?php echo number_format($row_item->qty_print,0,'.',',') ?></td>
	    	                    	<td align="center"><?php echo number_format($row_item->qty_press,0,'.',',') ?></td>
	    	                    	<td align="center"><?php echo number_format($row_item->qty,0,'.',',') ?></td>
	    	                    	<td align="center"><?php echo number_format($row_item->qty_damaged_print,0,'.',',') ?></td>
	    	                    	<td align="center"><?php echo number_format($row_item->qty_damaged_press,0,'.',',') ?></td>
	    	                    	<td align="center"><?php echo number_format($row_item->qty_damaged_counting,0,'.',',') ?></td>
	    	                    </tr>
