...
<table class="table" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family: Arial; font-size: 12px">
	<tr>
...
<table class="table" width="100%" border="1" cellpadding="0" cellspacing="0" style="border:#ccc; font-family: Arial; font-size: 12px">	
	...
	?>
			...
			<tr <?php echo $bgcolor; ?> >
				...
				<td align="right"><?php echo number_format($current_cost,"2",",",".") ?>&nbsp;</td>
	...
	<tr style="font-weight: bold">
		...
		<td align="right">&nbsp;</td>
		<td align="right"><?php echo number_format($grand_total_value,"2",",",".") ?>&nbsp;</td>
	</tr>
