<script type="text/javascript">
	function hapus(id) {
		if (confirm('Apakah Anda yakin akan menghapus data ini?')) {
			document.location.href = "main.php?menu=app&act=<?php echo obraxabrix('vendor_type_view') ?>&mxKz=xm8r389xemx23xb2378e23&id="+id+" ";
		}
	}
</script>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			?>
                    ...
                    <meta http-equiv="Refresh" content="0;url=main.php?menu=app&act=<?php echo obraxabrix('vendor_type_type_view') ?>" />
			<?php
                                        ...
                                        <tr>
											...
											<td>
                                                ...
                                                <?php if (allowupd('frmvendor_type')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('vendor_type') ?>&search=<?php echo $row_vendor_type->id ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
    													<span class="green">
                                                ...
                                                <?php if (allowdel('frmvendor_type')==1) { ?>    
                                                    &nbsp;
    												<a href="JavaScript:hapus('<?php echo $row_vendor_type->id ?>')" class="tooltip-error" data-rel="tooltip" title="Delete">
    													<span class="red">
