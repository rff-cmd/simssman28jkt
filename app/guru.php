	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_guru.php");
				
				$tanggal = date("d-m-Y");
				if ($ref != "") {
					$sql=$select->list_guru($ref);
					$row_guru=$sql->fetch(PDO::FETCH_OBJ);	
					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="guru" id="guru" enctype="multipart/form-data" onSubmit="return cekinput('idpelajaran');" >
            	...
            	<div class="form-group">
					...
					<?php if($ref == "") { ?>
						<div class="col-sm-4">
							<select name="idpelajaran" id="idpelajaran" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/guru_ajax.php','guru_pelajaran','geteguru','idpelajaran')" >
								<option value=""></option>
								<?php 
									//select_pelajaran_all($row_guru->idpelajaran); 
									select_pelajaran_krs($row_guru->idpelajaran);
								?>
							</select>
						</div>
					<?php } else { ?>
						<div class="col-sm-4">
							<select name="idpelajaran2" id="idpelajaran2" class="chosen-select form-control" disabled="" onchange="loadHTMLPost2('<?php echo $__folder ?>app/guru_ajax.php','guru_pelajaran','geteguru','idpelajaran')" >
								<option value=""></option>
								<?php 
									//select_pelajaran_all($row_guru->idpelajaran); 
									select_pelajaran_krs($row_guru->idpelajaran);
						...
						<input type="hidden" name="idpelajaran" id="idpelajaran" value="<?php echo $row_guru->idpelajaran ?>" />
					<?php } ?>
				</div>
            	...
            	<div id="guru_pelajaran">
            		<?php
            			...
            			if( !empty($ref) ) {
							include("guru_pelajaran_update.php");
						}
            		?>
            	</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('guru_view') ?>'" />
