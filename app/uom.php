		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" action="" method="post" name="uom" id="uom" enctype="multipart/form-data" onSubmit="return cekinput('code,name');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="code" name="code" class="form-control" autofocus="" autocomplete="off" value="<?php echo $row_uom->code ?>">
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="name" name="name" class="form-control" autocomplete="off" value="<?php echo $row_uom->name ?>">
					</div>
				</div><!-- /.form-group -->
