								...
								<div>
									...
									<table class="table" border="0">
										...
										<tr>
											<td>Jenis Anggota</td>
											<td>
												<!-- <select name="jenis_anggota" id="jenis_anggota" class='cho' style="min-width: 250px; height:27px; " onchange="departemen_member()" > -->
												<div class="col-sm-2">
										...
										<tr>
											...
											<td>
												<div class="col-sm-6">
													<!-- <input type="text" name="keterangan" id="keterangan" style="width:300px; " value="<?php echo $keterangan ?>"> -->
