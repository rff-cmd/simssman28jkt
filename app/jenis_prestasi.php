		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_jenis_prestasi=$sql->fetch(PDO::FETCH_OBJ);	
					
					if ($row_jenis_prestasi->aktif == 1) {
						$act = "checked";
					} else {
						$act = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="jenis_prestasi" id="jenis_prestasi" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('nama');" >
            	
            	<input type="hidden" id="replid" name="replid" value="<?php echo $ref ?>" >
                    	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Prestasi *)</label>
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $row_jenis_prestasi->nama ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="poin" name="poin" class="form-control" onkeyup="formatangka('poin')" value="<?php echo $row_jenis_prestasi->poin ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php if($row_jenis_prestasi->aktif==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
