...
<script>
	...
	function print_raport(idsiswa) {
		...
		window.open('<?php echo $__folder ?>app/raport_siswa_print.php?idsiswa='+idsiswa+'&semester_id='+semester_id+'&idkelas='+idkelas2+'&idtahunajaran='+idtahunajaran, 'Raport Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
	...
	function print_raport_absensi(idsiswa) {
		...
		window.open('<?php echo $__folder ?>app/raport_siswa_absensi_print.php?idsiswa='+idsiswa+'&semester_id='+semester_id+'&idkelas='+idkelas2+'&idtahunajaran='+idtahunajaran, 'Absensi Raport Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
	...
	function print_raport_aspek(idsiswa) {
		...
		window.open('<?php echo $__folder ?>app/raport_siswa_aspek_print.php?idsiswa='+idsiswa+'&semester_id='+semester_id+'&idkelas='+idkelas2+'&idtahunajaran='+idtahunajaran, 'Raport Aspek Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
	...
	function print_raport_cover(idsiswa) {
		...
		window.open('<?php echo $__folder ?>app/raport_siswa_cover_print.php?idsiswa='+idsiswa, 'Invoice Print','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
	
	function print_raport_cover_kelas(idtingkat,idkelas) {
		window.open('<?php echo $__folder ?>app/raport_siswa_cover_kelas_print.php?idtingkat='+idtingkat+'&idkelas='+idkelas, 'Raport Print Cover','825','450','resizable=1,scrollbars=1,status=0,toolbar=0')
	}
</script>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="siswa_lis" id="siswa_list" enctype="multipart/form-data" >
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Cetak Cover Rapor per Tingkat/Kelas</label>
		                    <div class="col-sm-8">
						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th>Cetak Absen</th>
									<th>Cetak Aspek</th>-->
									<th>Cetak Cover Rapor</th>
								</tr>
							</thead>

							<tbody>
                                <?php			
									$sql=$selectview->list_siswa('', '', $idtingkat2, $idkelas2, $nama2, $all, 'SMA', '', '', '1');
								...
								?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">	
												<a href="JavaScript:print_raport_cover(<?php echo $siswa_view->replid ?>)" class="tooltip-error" data-rel="tooltip" title="Print Cover Rapor">
					            					<span class="green">
														<i class="ace-icon glyphicon glyphicon-print bigger-120"></i>
													</span>
												</a>
