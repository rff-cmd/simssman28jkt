		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_datapenerimaan=$sql->fetch(PDO::FETCH_OBJ);	
					
					if ($row_datapenerimaan->aktif == 1) {
						$act = "checked";
					} else {
						$act = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="datapenerimaan" id="datapenerimaan" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('idkategori,departemen,nama,rekkas,rekpendapatan,rekpiutang');" >
            	
            	<input type="hidden" id="id" name="id" value="<?php echo $ref ?>" >
            	<input type="hidden" id="departemen" name="departemen" value="SMA" >
				<input type="hidden" id="oldnama" name="oldnama" value="<?php echo $row_datapenerimaan->nama ?>" >
				<input type="hidden" id="olddepartemen" name="olddepartemen" value="<?php echo $row_datapenerimaan->departemen ?>" >
				<input type="hidden" id="oldidkategori" name="oldidkategori" value="<?php echo $row_datapenerimaan->idkategori ?>" >
                
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Kategori *)</label>
                    <div class="col-sm-3">
                    	 <select name="idkategori" id="idkategori" class="chosen-select form-control" />
							<option value=""></option>
							<?php select_kategoripenerimaan($row_datapenerimaan->idkategori); ?>
						</select>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $row_datapenerimaan->nama ?>">
					</div>
				</div>
						    	
            	<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Rekening Kas *)</label>
					<div class="col-sm-3">
						<select name="rekkas" id="rekkas" class="chosen-select form-control"  />
							<option value=""></option>
							<?php select_rekakun('HARTA', $row_datapenerimaan->rekkas); ?>
						</select>
					</div>
				</div>
				
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Rekening Pendapatan *)</label>
					<div class="col-sm-3">
						<select name="rekpendapatan" id="rekpendapatan" class="chosen-select form-control" />
							<option value=""></option>
							<?php select_rekakun('PENDAPATAN', $row_datapenerimaan->rekpendapatan); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Rekening Piutang *)</label>
					<div class="col-sm-3">
						<select name="rekpiutang" id="rekpiutang" class="chosen-select form-control" />
							<option value=""></option>
							<?php select_rekakun('PIUTANG', $row_datapenerimaan->rekpiutang); ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_datapenerimaan->keterangan ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="nourut" id="nourut" class="form-control" onkeyup="formatangka('nourut')" value="<?php echo $row_datapenerimaan->nourut ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Harus Lunas</label>
					<div class="col-sm-3">
						<input type="checkbox" name="full" id="full" class="ace" value="1" <?php echo $full ?> ><span class="lbl"></span>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php if($row_datapenerimaan->aktif==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
