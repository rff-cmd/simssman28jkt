								...
								<div>
									...
									<table class="table" border="0">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" style="min-width: 178px; height:27px; " />
													<option value=""></option>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="nama" id="nama" style="width:250px; " value="<?php echo $perpustakaan_data->nama ?>"></td>
										</tr>
