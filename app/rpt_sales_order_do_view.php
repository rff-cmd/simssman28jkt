					...
					<div>
						...
						<table class="table" class="table table-striped table-bordered table-hover">
							<thead>
								...
								<?php
									$sql_do = $selectview->get_count_do_so($row_so->ref);
									$count_do = $sql_do->rowCount();
								...
								<tr>
		                        	...
		                        	<td align="center" rowspan="3">Keterangan</td>
		                        	<td align="center" rowspan="3">Ukuran</td>
		                        	<td align="center" rowspan="3">JML</td>
		                        	<td align="center" colspan="<?php echo $count_do * 2 ?>">Kirim</td>
		                        ...
		                        <tr>
		                        	<?php
		                        		//$machine_id = array();
		                        		while($data_do = $sql_do->fetch(PDO::FETCH_OBJ)) {
											//$machine_id[] = $data_machine->id;
		                        	?>
		                        			<td align="center" colspan="2"><?php echo $data_do->date ?></td>
		                        	<?php
										}
		                        	?>
	                      	...
	                      	<?php
	                            ...
	                            $sql=$selectview->rpt_sales_order_do_detail($ref);
