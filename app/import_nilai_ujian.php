	        ...
	        while (($column = fgetcsv($file, 20000, ";")) !== FALSE) {
	        	...
	        	if($x > 0) {
					...
					if($nis != "") {
						...
						//update hasil raport
						import_ujian($data->replid, $data->idtingkat, $data->idkelas, $_SESSION[idtahunajaran], $_SESSION[semester_id], $idpelajaran);
	        ...
	        while (($column = fgetcsv($file, 20000, ",")) !== FALSE) {
	        	...
	        	if($x > 0) {
					...
					if($nis != "") {
						...
						//update hasil raport
						import_ujian($idsiswa, $data->idtingkat, $data->idkelas, $_SESSION[idtahunajaran], $_SESSION[semester_id], $idpelajaran);
