				...
				<div class="col-xs-12">
					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$sql=$selectview->list_purchase_inv_consign($kode, $from_date, $to_date, $vendor_code, $all);
									while($row_purchase_inv=$sql->fetch(PDO::FETCH_OBJ)){
			                                ...
			                                while($row_purchase_inv_det=$sql2->fetch(PDO::FETCH_OBJ)) {
			                                    if($item_name == "") {
			                                        $item_name =  $row_purchase_inv_det->item_name; 
			                                    } else {
			                                        $item_name =  $item_name . '<br>' . $row_purchase_inv_det->item_name; 
			                                    }
								...
								?>
                                        ...
                                        <tr>
						                    ...
						                    <td align="right"><?php echo $row_purchase_inv->tax_rate ?></td>
						                    <td align="right"><?php echo $tax_amount ?></td>
											<!--<td><?php echo $row_purchase_inv->memo ?></td>-->
				                            <td><?php echo $item_name ?></td>
				                            <td align="right"><?php echo number_format($row_purchase_inv->total,"0",".",",") ?></td>
