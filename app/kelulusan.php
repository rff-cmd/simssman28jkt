									...
									<div class="widget-main">
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select name="idtingkat2" id="idtingkat2" class="chosen-select form-control" onchange="loadHTMLPost2('<?php echo $__folder ?>app/kenaikan_ajax.php','kelas_id','getkelas','idtingkat2')">
														<option value=""></option>
