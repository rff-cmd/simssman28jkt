								...
								<div>
									...
									<table class="table" border="0" cellpadding="5">
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="departemen" id="departemen" class='cho' style="min-width: 250px; height:27px; " onchange="loadHTMLPost2('app/daftarpustaka_ajax.php','pustaka_id','getpustaka','departemen')" >
													<option value="">...</option>
										...
										<tr>
											...
											<td>:</td>
											<td id="pustaka_id">
												<select name="pustaka" id="pustaka" class='cho' style="min-width: 250px; height:27px; " >
													<option value="">...</option>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td id="kodepustaka_id"><input type="text" name="kodepustaka" id="kodepustaka" style="width:250px; " onblur="loadHTMLPost3('app/daftarpustaka_ajax.php','kodepustaka_id','cekkodepustaka','id','kodepustaka')" value="<?php echo $daftarpustaka_data->kodepustaka ?>"></td>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="status" id="status" class='cho' style="min-width: 178px; height:27px; min-width:100px ">
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="ts" id="ts" readonly="" style="width:250px; " value="<?php echo $ts ?>"></td>
										</tr>
