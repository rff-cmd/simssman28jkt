...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="besarjtt" id="besarjtt" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('idpenerimaan,departemen');" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idkategori" id="idkategori" class="chosen-select form-control" onClick="loadHTMLPost2('app/besarjtt_ajax.php','id_penerimaan','getkategori','idkategori','departemen')" />
							<option value=""></option>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="besar" id="besar" class="form-control" onkeyup="formatangka('besar')" value="<?php echo number_format($besarjtt_data->besar,'0','.',',') ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="cicilan" id="cicilan" class="form-control" onkeyup="formatangka('cicilan')" value="<?php echo number_format($besarjtt_data->cicilan,'0','.',',') ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tanggal Jurnal</label>
					<div class="col-sm-3">
