	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_siswa_krs.php");
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="siswa_krs" id="siswa_krs" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('semester_id');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="pegawai_id" id="pegawai_id" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_petugas($row_siswa_krs->pegawai_id); ?>
						</select>
					</div>
				</div>
				<!--onChange="loadHTMLPost2('app/presensipelajaran_ajax.php','siswa_krs_pelajaran','getkrs','nis','semester_id')" -->
                <div class="form-group">
					...
					<div class="col-lg-4">
						<select name="idpelajaran" id="idpelajaran" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_pelajaran("SMA", $row_siswa_krs->idpelajaran); ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-2">
						<select name="semester_id" id="semester_id" class="chosen-select form-control">
							<option value=""></option>
							<?php select_kelasfilter("", $row_siswa_krs->semester_id); ?>
						</select>
					</div>
				</div>
            	...
            	<div id="siswa_krs_pelajaran">
            		<?php
            			if( !empty($ref) ) {
							include("presensipelajaran_siswa_update.php");
						} else {
							include("presensipelajaran_siswa.php");
						}
            		?>
            	</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowupd('frmsiswa_krs')==1) { ?>
                            <?php if($ref!='') { ?>
    							<input type="submit" name="submit" id="submit" class='btn btn-primary' value="Update" />
    						<?php } ?>
                        <?php } ?>
						
                        <?php if (allowadd('frmsiswa_krs')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('siswa_krs_view') ?>'" />
