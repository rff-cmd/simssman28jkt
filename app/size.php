...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="" method="post" name="size" id="size" enctype="multipart/form-data" onSubmit="return cekinput('name');" >
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Ukuran *)</label>
					<div class="col-sm-3">
						<input type="tel" id="name" name="name" onkeyup="formatangka('name')" class="form-control" value="<?php echo $row_size->name ?>">
					</div>
				</div>
