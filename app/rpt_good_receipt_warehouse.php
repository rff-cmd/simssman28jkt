...
$warehouse_id_from		=	 $_REQUEST['warehouse_id_from'];
$warehouse_id_to		=	 $_REQUEST['warehouse_id_to'];
$all			       	=    $_REQUEST['all'];
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="purchase_view" id="purchase_view" class="form-horizontal" enctype="multipart/form-data" >
						...
						<div class="form-group">
	                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Dari Lokasi *)</label>
	                        <div class="col-sm-3">
	                          <select id="warehouse_id_from" name="warehouse_id_from" class="chosen-select form-control" style="width: auto">
	                            <option value=""></option>
	                            <?php 
	                            	select_location($warehouse_id_from)
	                            ?>	                            
	                          </select>
						...
						<div class="form-group">
	                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Ke Lokasi *)</label>
	                        <div class="col-sm-3">
				...
				<div class="col-xs-12">
					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									$sql=$select->list_outbound("", $from_date, $to_date, $all, $warehouse_id_from, $warehouse_id_to);
