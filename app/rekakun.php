		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_rekakun=$sql->fetch(PDO::FETCH_OBJ);	
					
					if ($row_rekakun->aktif == 1) {
						$act = "checked";
					} else {
						$act = "";
					}
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="rekakun" id="rekakun" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('kategori,kode,nama');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="kategori" id="kategori" class="chosen-select form-control" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kode" name="kode" class="form-control" value="<?php echo $row_rekakun->kode ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $row_rekakun->nama ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_rekakun->keterangan ?></textarea>
					</div>
				</div>
