					...
					<div>
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<tbody>
                                <?php			
									...
									while($row_purchase_return=$sql->fetch(PDO::FETCH_OBJ)){
			                                ...
			                                $tax_amount = ($row_purchase_return->tax_rate * $row_purchase_return->total)/100;
			                                $tax_amount = number_format($tax_amount,2,".",",");
			                                
											$i++;
											
											$grand_total_tax = $grand_total_tax + numberreplace($tax_amount);
											$grand_total = $grand_total + $row_purchase_return->total;
							...
							<tr style="font-weight: bold; font-size: 16px; background-color: #c5fec0">
                                ...
                                <td align="right"><?php echo number_format($grand_total_tax,2,".",",") ?></td>
