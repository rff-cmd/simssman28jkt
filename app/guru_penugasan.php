	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					$sql=$select->list_guru_penugasan("", $segmen4, $ref);
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="guru_penugasan" id="guru_penugasan" enctype="multipart/form-data" onSubmit="return cekinput('idtahunajaran,idpegawai');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="checkbox" name="aktif" id="aktif" class="ace" style="" value="1" <?php echo $aktif ?> ><span class="lbl"></span>
					</div>
				</div>
