		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_angkatan=$sql->fetch(PDO::FETCH_OBJ);	
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="angkatan2" id="angkatan2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('angkatan');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="departemen" id="departemen" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_departemen($row_angkatan->departemen); ?>
						</select>
					</div>
				</div>
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="angkatan" name="angkatan" class="form-control" value="<?php echo $row_angkatan->angkatan ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_angkatan->keterangan ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input class="ace" type="checkbox" name="aktif" id="aktif" value="1" <?php if($row_angkatan->aktif==1) echo "checked";?>/>
						<?php } ?>
						<span class="lbl"></span>
