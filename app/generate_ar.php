...
<div class="page-content">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="generate_ar" id="generate_ar" enctype="multipart/form-data" onSubmit="return cekinput('idangkatan,idtingkat,tahunbuku,finance_type');" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="amount" name="amount" onkeyup="formatangka('amount')" class="form-control" style="text-align: right" value="">							
					</div>
				</div>
			...
			if($_POST["submit"]) {
				...
				$sqlcln = $selectview->list_siswa('', '', '', '', '', '', 'SMA', '', '', '', '0', $idangkatan, '');
			...
			<table class="table" align="center" style="font-size: 25px; color: #07581c">
				<tr>
