<!-- <table class="table" width="100%" border="0" style="border: 1px solid #ccc"> -->
<table class="table" id="simple-table" class="table table-striped table-bordered table-hover" style="100%">
	<!--
    <tr>
		<td>
			<select name="pilihan" id="pilihan" onclick="loadHTMLPost2('app/pinjam_ajax.php','pustaka_id','getpilihan','pilihan')" style="min-width: 178px; height:27px; " />
	...
	<tr style="font-weight: bold">		
		<!--<td colspan="2">-->
			<!--<table>-->
                <!--
				<tr id="pustaka_id">
					<td><input type="text" name="kodepustaka" id="kodepustaka" onKeyPress="return focusNext('submitdetail',event)" onblur="loadHTMLPost2('app/pinjam_ajax.php','pustaka_id','getpustaka','kodepustaka')" style="width:120px; " value="<?php echo $kodepustaka2 ?>"></td>
					<td><input type="text" readonly="" name="judul" id="judul" style="width:300px; " value="<?php echo $judul ?>"></td>
				</tr>-->
            ...
            <table class="table" width="100%">
                <tr id="pustaka_id">
                    ...
                    <td width="30%">
                        ...
                        <!-- <input type="text" name="kodepustaka" id="kodepustaka" onblur="loadHTMLPost2('app/pinjam_ajax.php','pustaka_id','getpustaka','kodepustaka')" onKeyPress="return focusNext('submitdetail',event)" style="width:120px; " value="<php echo $kodepustaka2 ?>"> -->

                        <input type="text" name="kodepustaka" id="kodepustaka" class="form-control" style="width:120px;"value="<?php echo $kodepustaka2 ?>">
                    </td>
            		<td width="70%">
            			<!-- <input type="text" readonly="" name="judul" id="judul" style="width:300px; " value="<php echo $judul ?>"> -->
		...
		<td>
			<!-- <input type="text" name="tglpinjam" class='datepick' id="tglpinjam" style="width:100px; " value="<php echo $tglpinjam ?>"> -->
		...
		<td>
			<!-- <input type="text" name="tglkembali" class='datepick' id="tglkembali" style="width:100px; " value="<php echo $tglkembali ?>"> -->
...
?>
	...
	<table class="table" border="0" style="border: 1px solid #ccc">	
		<tr style="font-weight: bold">
			<td>No</td>
			<td>No. Pustaka</td>
			<td>Judul</td>
