								...
								<div>
									...
									<table class="table" border="0">
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="noregistrasi" id="noregistrasi" readonly="" style="width:110px; " value="<?php echo $ref2 ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="nama" id="nama" style="width:180px; " value="<?php echo $anggota_data->nama ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="kodepos" id="kodepos" style="width:80px; " value="<?php echo $anggota_data->kodepos ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="email" id="email" style="width:180px; " value="<?php echo $anggota_data->email ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="telpon" id="telpon" style="width:180px; " value="<?php echo $anggota_data->telpon ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="HP" id="HP" style="width:180px; " value="<?php echo $anggota_data->HP ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="pekerjaan" id="pekerjaan" style="width:180px; " value="<?php echo $anggota_data->pekerjaan ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="institusi" id="institusi" style="width:180px; " value="<?php echo $anggota_data->institusi ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="text" name="tgldaftar" id="tgldaftar" class='datepick' style="width:180px; " value="<?php echo $tgldaftar ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>&nbsp;&nbsp;</td>
											<td>:</td>
											<td><input type="checkbox" name="aktif" id="aktif" style="" value="1" <?php echo $aktif ?> ></td>	
										</tr>
