...
<script type="text/javascript">
	function jadwal_input(hari, idtingkat, idkelas, idguru, idjam) {
		window.open("app/jadwal_input.php?hari="+hari+"&idtingkat="+idtingkat+"&idkelas="+idkelas+"&idguru="+idguru+"&idjam="+idjam,"Find","width=500,height=620,left=50,top=10,toolbar=0,status=0,scroll=1,scrollbars=no");
	}
	
	function jadwal_update(hari, idtingkat, idkelas, idguru, idjam, idjadwal) {
		window.open("app/jadwal_update.php?hari="+hari+"&idtingkat="+idtingkat+"&idkelas="+idkelas+"&idguru="+idguru+"&idjam="+idjam+"&idjadwal="+idjadwal,"Find","width=500,height=620,left=50,top=10,toolbar=0,status=0,scroll=1,scrollbars=no");
	}
</script>            
		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" action="" method="post" name="jadwal" id="jadwal" enctype="multipart/form-data" onSubmit="return cekinput('hari,idtingkat');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="hari" id="hari" class="chosen-select form-control" onchange="loadHTMLPost2('app/jadwal_ajax.php','jadwal_jam','getjadwal','hari','idtingkat','idguru')" >
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select name="idtingkat" id="idtingkat" class="chosen-select form-control" onchange="loadHTMLPost2('app/jadwal_ajax.php','jadwal_jam','getjadwal','hari','idtingkat','idguru')" >
							<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="idguru" id="idguru" class="chosen-select form-control" onchange="loadHTMLPost2('app/jadwal_ajax.php','jadwal_jam','getjadwal','hari','idtingkat','idguru')" >
							<option value=""></option>
