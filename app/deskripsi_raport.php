	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/insert_deskripsi_raport.php");
				
				$ekstra_sifat = "";
				$aktif = "checked";
				if ($ref != "") {
					$sql=$select->list_deskripsi_raport($ref);
					$deskripsi_raport_data=$sql->fetch(PDO::FETCH_OBJ);	
					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="deskripsi_raport2" id="deskripsi_raport2" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('idangkatan,idpelajaran');" >
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<select name="idangkatan" id="idangkatan" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_angkatan($deskripsi_raport_data->idangkatan) ?>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">						
						<select name="sikap" id="sikap" class="chosen-select form-control" >
							<option value=""></option>
							<?php select_sikap_raport($deskripsi_raport_data->sikap) ?>
						</select>						
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Deskripsi-A</label>
					<div class="col-sm-5">
						<textarea id="sikap_a" name="sikap_a" class="form-control"><?php echo $deskripsi_raport_data->sikap_a ?></textarea>
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Deskripsi-B</label>
					<div class="col-sm-5">
						<textarea id="sikap_b" name="sikap_b" class="form-control"><?php echo $deskripsi_raport_data->sikap_b ?></textarea>
					</div>
				</div>
				
				<!------------->
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Deskripsi-C</label>
					<div class="col-sm-5">
						<textarea id="sikap_c" name="sikap_c" class="form-control"><?php echo $deskripsi_raport_data->sikap_c ?></textarea>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
                        ...
                        <?php if (allowadd('frmdeskripsi_raport')==1) { ?>
    						<?php if($ref=='') { ?>
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('deskripsi_raport_view') ?>'" />
