	...
	function cekinput(fid) {  
	  ...
	  for(i=0; i < arrf.length; i++) {
		if(document.getElementById(arrf[i]).value=='') {       
		  ...
		  if (document.getElementById(arrf[i]).name=='asset_type_id') {
	...
	<div class="row">
		<div class="col-xs-12">
            ...
            <?php 
				...
				include("app/exec/build_insert.php"); 
				
				if ($ref != "") {
					$sql=$select->list_build($ref);
					$row_build=$sql->fetch(PDO::FETCH_OBJ);	
					
                    $ref2 = $row_build->ref;
                    $tanggal_perolehan = $row_build->tanggal_perolehan;
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="build" id="build" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('ref,asset_name,asset_type_id');" >
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">No. Inv. *)</label>
					<div class="col-lg-3">
						<input type="text" id="ref_id" name="ref_id" class="form-control" value="<?php echo $row_build->ref_id ?>">
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Nama Inv. *)</label>
					<div class="col-sm-3">
						<input type="text" id="asset_name" name="asset_name" class="form-control" value="<?php echo $row_build->asset_name ?>">
					</div>
				</div>
                
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Jenis Inv. *)</label>
                    <div class="col-sm-3">
                      <select id="asset_type_id" name="asset_type_id" class="chosen-select form-control" tabindex="2" style="width: auto">
                        <option value=""></option>
                        <?php 
                        	combo_select_active("asset_type","id","type","active","1",$row_build->asset_type_id) 
                        ?>	                            
                      </select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="lokasi" name="lokasi" class="autosize-transition form-control"><?php echo $row_build->lokasi ?></textarea>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="alamat" name="alamat" class="form-control" value="<?php echo $row_build->alamat ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="lintang" name="lintang" class="form-control" value="<?php echo $row_build->lintang ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="bujur" name="bujur" class="form-control" value="<?php echo $row_build->bujur ?>">
					</div>
				</div>*/ ?>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="autosize-transition form-control"><?php echo $row_build->keterangan ?></textarea>
					</div>
				</div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-xs-3">
                        ...
                        <br />
        				<?php if (!empty($row_build->photo)) { ?>
        					<img src="app/photo_build/<?php echo $ref . '/' . $row_build->photo; ?>" width="50" height="50" />
        				<?php } ?>
                        <input size="25" type="hidden" id="photo2" name="photo2" value="<?php echo $row_build->photo; ?>">  
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<?php } else { ?>
							<input type="checkbox" name="active" id="active" class="ace" value="1" <?php if($row_build->active==1) echo "checked";?>/><span class="lbl"></span>
						<?php } ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="uid" name="uid" readonly class="form-control" value="<?php echo $row_build->uid ?>">
					</div>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="dlu" name="dlu" readonly class="form-control" value="<?php echo $row_build->dlu ?>" >
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						...
						&nbsp;
						<input type="button" name="submit" id="submit" class="btn btn-success" value="List Data" onclick="self.location='<?php echo $nama_folder . '/' . obraxabrix('build_view') ?>'" />
