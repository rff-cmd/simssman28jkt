		...
		<div class="col-xs-12">
            ...
            <?php 
				...
				if ($ref != "") {
					...
					$row_format=$sql->fetch(PDO::FETCH_OBJ);	
					
				}		
			?>
            
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" action="" method="post" name="format" id="format" class="form-horizontal" enctype="multipart/form-data" onSubmit="return cekinput('kode,nama');" >
            	...
            	<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="kode" name="kode" class="form-control" value="<?php echo $row_format->kode ?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="nama" name="nama" class="form-control" value="<?php echo $row_format->nama ?>">
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-3">
						<textarea id="keterangan" name="keterangan" class="form-control"><?php echo $row_format->keterangan ?></textarea>
					</div>
				</div>
