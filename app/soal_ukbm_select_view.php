<table class="table" id="dynamic-table" class="table table-bordered table-condensed table-hover table-striped" style="width: auto;">
	<thead>
	...
	<tbody>
		...
		<?php	
			$no = 0;
			$sql=$select->list_soal_ukbm("", $idtingkat, $idsemester, $idjurusan, 1);
