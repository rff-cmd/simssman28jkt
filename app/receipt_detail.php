 ...
 <table class="table" id="simple-table" class="table table-striped table-bordered table-hover" />
	...
	<tbody>
		<?php 
			...
			if($row_receipt_detail->invoice_type == "cashier") {
				$transaction = "Simpanan Wajib";
			}
		...
		?>								
			...
			<tr style="background-color:ffffff;"> 
				...
				<!--<td align="right" id="discount<?php echo $no ?>">-->
					<input type="hidden" id="discount_<?php echo $no; ?>" name="discount_<?php echo $no; ?>" style="text-align: right; width: 110px" class="form-control" onkeyup="formatangka('discount_<?php echo $no; ?>'), sub_totals('<?php echo $jmldata ?>')" readonly value="<?php echo $discount ?>" >
				<!--</td>-->
				...
				<td align="center">
					<input type="checkbox" id="delete_<?php echo $no; ?>" name="delete_<?php echo $no; ?>" class="ace" onchange="cek_one_del('<?php echo $no ?>', '<?php echo $jmldata; ?>')" value="1" ><span class="lbl"></span>
				</td>
