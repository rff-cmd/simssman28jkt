		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" role="form" action="" method="post" name="rpt_ap" id="rpt_ap" class="form-horizontal" enctype="multipart/form-data" >
						...
						<table class="table" id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
			                    	...
			                    	<th><?php if($lng==1) { echo 'Supplier Name'; } else { echo 'Nama Supplier'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Tax Rate (%)'; } else { echo 'PPN (%)'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Tax Amount'; } else { echo 'PPN'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Amount Due'; } else { echo 'Total Hutang'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Amount Paid'; } else { echo 'Total Bayar'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Balance'; } else { echo 'Sisa'; } ?></th>
			                    	<th><?php if($lng==1) { echo 'Pay'; } else { echo 'Bayar'; } ?></th>
							...
							<tbody>
                                <?php			
									$sql=$selectview->rpt_ap_outstanding($from_date, $to_date, $all, $vendor_code);										while ($row_rpt_ap=$sql->fetch(PDO::FETCH_OBJ)) {
										
										$tax_rate = $row_rpt_ap->tax_rate;
										$tax_rate = number_format($tax_rate, 0, ".",",");
										
										$tax_amount = ($row_rpt_ap->tax_rate * $row_rpt_ap->amount_total)/100;
										$tax_amount = number_format($tax_amount, 0, ".",",");
								...
								?>
                                        ...
                                        <tr>
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $row_rpt_ap->date ?></td>
					                    	<td><?php echo $row_rpt_ap->invoice_no ?></td>
				                            <td><?php echo $row_rpt_ap->vendor_name ?></td>
					                    	<td align="right"><?php echo $tax_rate ?>%</td>
					                    	<td align="right"><?php echo $tax_amount ?></td>
					                    	<td align="right"><?php echo number_format($row_rpt_ap->credit_amount,0,".",",") ?></td>
					                    	<td align="right"><?php echo number_format($row_rpt_ap->debit_amount,0,".",",") ?></td>
					                    	<td align="right"><?php echo number_format($row_rpt_ap->amount,0,".",",") ?></td>
											<td>
                                            
                                                <?php if (allowupd('frmpayment')==1) { ?>
    												<a href="main.php?menu=app&act=<?php echo obraxabrix('payment2') ?>&vendor_code=<?php echo $row_rpt_ap->contact_code ?>&invno=<?php echo $row_rpt_ap->invoice_no ?>" class="tooltip-success" data-rel="tooltip" title="Payment">
    													<span class="green">
